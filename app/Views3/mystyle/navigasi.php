        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link <?php if($title == 'Dashboard'){ echo 'active';}; ?>" href="<?= base_url() ?>">
                        <i class="icofont-home fs-5"></i> 
                        <span>Dashboard</span>
                        </a>
                    </li>
                    <li><a class="m-link <?php if($title == 'Keranjang Belanja'){ echo 'active';}; ?>" href="<?= base_url() ?>keranjang">
                        <i class="icofont-shopping-cart fs-5"></i> 
                        <span>Keranjang belanja</span>
                        </a>
                    </li>
                    <li><a class="m-link <?php if($title == 'Orders'){ echo 'active';}; ?>" href="<?= base_url() ?>orders">
                    ...
                    <?php if(in_groups('admin')): ?>
                        <li><a class="m-link <?php if($title == 'Dashboard'){ echo 'active';}; ?>" href="<?= base_url() ?>admin">
                            <i class="icofont-home fs-5"></i> 
                            <span>Dashboard</span>
                            </a>
                        </li>
                    ...
                    <?php if(in_groups('admin')): ?>
                        <li><a class="m-link <?php if($title == 'Produk list'){ echo 'active';}; ?>" href="<?= base_url() ?>admin/products_list">
                            <i class="icofont-prestashop fs-5"></i> 
                            <span>Products</span>
                            </a>
                        </li>

                        <li><a class="m-link <?php if($title == 'Orders list'){ echo 'active';}; ?>" href="<?= base_url() ?>admin/orders_list">
                            <i class="icofont-listine-dots fs-5"></i> 
                            <span>Orders List</span>
                            </a>
                        </li>

                        <li><a class="m-link <?php if($title == 'laporan'){ echo 'active';}; ?>" href="<?= base_url() ?>admin/laporan">
                            <i class="icofont-listine-dots fs-5"></i> 
                            <span>Laporan</span>
                            </a>
                        </li>
